...
public class dragdropActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new dragdropAdapter(datalist,this,this);
            ...
            public void onClick(View v) {
                switch (count){
                    case(1):{
                        ...
                        if(ishorizon){
                            LinearLayoutManager linearLayoutManager = new LinearLayoutManager(dragdropActivity.this,LinearLayoutManager.VERTICAL,false);
                            recyclerView.setLayoutManager(linearLayoutManager);
                        }else{
                            LinearLayoutManager linearLayoutManager = new LinearLayoutManager(dragdropActivity.this,LinearLayoutManager.HORIZONTAL,false);
                            recyclerView.setLayoutManager(linearLayoutManager);
                        }
                        ishorizon = !ishorizon;
                    ...
                    case(2):{
                        ...
                        if(ishorizon){
                            GridLayoutManager mGrid = new GridLayoutManager(dragdropActivity.this,3);
